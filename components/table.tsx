...
export default function Table({ products, total, page, pages }: Props) {
  ...
  const getStatus = (stock?: number) => {
    if (!stock || stock === 0) return <span className="text-danger font-medium">Out of stock</span>;
    if (stock < 20) return <span className="text-warning font-medium">Low stock</span>;
