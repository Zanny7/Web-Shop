    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="mt-3 text-sm space-y-1">
                ...
                <p>
                  <span className="font-medium">Price:</span> {product.price} kr
                </p>
                <p>
            ...
            <tbody className="divide-y divide-gray-200">
              {products.map((product) => (
                ...
                >
                  ...
                  <td className="px-6 py-5 text-gray-700">{product.category?.name}</td>

                  <td className="px-6 py-5 font-medium">{product.price} kr</td>
        ...
        <footer className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-4 border-t bg-gray-50 text-sm text-gray-500">
          <p>
            Showing {(page - 1) * 6 + 1} to {Math.min(page * 6, total)} of {total} products
          </p>
                ...
                item === "..." ? (
                  ...
                  <Link
                    ...
                    className={`px-3 py-1 rounded-md ${
                      Number(page) === Number(item) ? "bg-purple-600 text-white" : "border bg-white hover:bg-gray-100"
                    }`}
                  >
                    {item}
                  </Link>
